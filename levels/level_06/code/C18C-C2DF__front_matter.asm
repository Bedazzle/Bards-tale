; --- Level 06 (Catacombs 1) front matter ($C18C-$C2DF) ---
; @done  Dispatch JP + ADDR_TABLE/addr_table_2 (DW label+1) + decoder. Relocatable.

LEVEL_START:
	jp	handle_move_key
redraw_vector:
	jp	refresh_dungeon_view

	jp	process_turn

	jp	handle_wandering_creature
...
ADDR_TABLE:
		...
		DW handle_chest.skip8+24		; 1E
		DW handle_chest.skip8+56		; 1F

...
; $C18C-$C19D - dispatch JP table (6 vectors, slot roles fixed across overlays).
LEVEL_START:
...
ADDR_TABLE:
		...
		DW wandering_creature_data+17		; 1E
		DW wandering_creature_data+49		; 1F
		...
		DW wandering_creature_data+1		; 52
...
; $C2C2-$C2DF - text-decoder clone (byte-identical to level_02's print_msg_cellars).
print_msg_sewers:
	PUSH_REGS
